...
export function Journey() {
    return (
        <div className="flow-root">
            <div className='flex justify-center font-bold text-[4rem] italic' >
                Deep Lawn's Journey
            </div>
                    ...
                    <div className="relative text-gray-700 antialiased text-sm font-semibold">
                        ...
                        <div className="mt-6 sm:mt-0 sm:mb-12">
                            <div className="flex flex-col sm:flex-row items-center">
                                <div className="flex justify-start w-full mx-auto items-center">
                                    <div className="w-full sm:w-1/2 sm:pr-8">
                                        <div className='flex justify-center' >
                                            ...
                                            <img className='object-fill' src="https://res.cloudinary.com/dcomv7wly/image/upload/v1671906624/the-beginning_fjhsar.jpg" alt="" />
                                ...
                                <div className="rounded-full bg-white  shadow-[inset_0_3px_6px_0_rgb(0,0,0,16%)] border-white border-8 w-24 h-24 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
                                    <p className="text-[1.2rem]">2011</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-6 sm:mt-0 sm:mb-12">
                            <div className="flex flex-col sm:flex-row items-center">
                                <div className="flex justify-end w-full mx-auto items-center">
                                    ...
                                    <div className="w-full sm:w-1/2 sm:pl-12">
                                        ...
                                        <div className='flex justify-center' >
                                            ...
                                            <img src="https://res.cloudinary.com/dcomv7wly/image/upload/v1671906625/The-Acquisition_to2fzq.jpg" alt="" />
                                ...
                                <div className="rounded-full bg-white  shadow-[inset_0_3px_6px_0_rgb(0,0,0,16%)] border-white border-8 w-24 h-24 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
                                    <p className="text-[1.2rem]">2019</p>
                                </div>
                            </div>
                        </div>
                        {/* Left section, set by justify-start and sm:pr-8 */}
                        <div className="mt-6 sm:mt-0 sm:mb-12">
                            <div className="flex flex-col sm:flex-row items-center">
                                <div className="flex justify-start w-full mx-auto items-center">
                                    <div className="w-full sm:w-1/2 sm:pr-12">
                                        <div className='flex justify-center' >
                                            ...
                                            <img src="https://res.cloudinary.com/dcomv7wly/image/upload/v1671906625/The-Idea_uysgf8.jpg" alt="" />
                                ...
                                <div className="rounded-full bg-white  shadow-[inset_0_3px_6px_0_rgb(0,0,0,16%)] border-white border-8 w-24 h-24 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
                                    <p className="text-[1.2rem]">2020</p>
                                </div>
                            </div>
                        </div>
                        {/* Right section, set by justify-end and sm:pl-8 */}
                        <div className="mt-6 sm:mt-0">
                            <div className="flex flex-col sm:flex-row items-center">
                                <div className="flex justify-end w-full mx-auto items-center">
                                    <div className="w-full sm:w-1/2 sm:pl-12">
                                        <div className='flex justify-center' >
                                            ...
                                            <img src="https://res.cloudinary.com/dcomv7wly/image/upload/v1671906624/Screen_Shot_2022-09-08_at_9.01.49_PM_ptxodh.png" alt="" />
                                ...
                                <div className="rounded-full bg-white  shadow-[inset_0_3px_6px_0_rgb(0,0,0,16%)] border-white border-8 w-24 h-24 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
                                    <p className="text-[1.2rem]">2021</p>
                                </div>
                            </div>
                        </div>
                    </div>
